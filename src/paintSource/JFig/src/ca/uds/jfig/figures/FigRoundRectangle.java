...
public class FigRoundRectangle extends FigureRectangle{
	
	private  RoundRectangle2D.Double shape2d;
	final private double arcw=20, arch=20;
	
	public FigRoundRectangle(Point2D point1, Point2D point2, Color borderColor, Color fillColor, int stroke, int angle){
		super(point1, point2, borderColor, fillColor, stroke, angle);		
		this.shape2d=new RoundRectangle2D.Double(x1,y1,x2-x1,y2-y1, arcw, arch);
	}
	...
	public void move(double x,double y){
		...
		this.shape2d.setRoundRect(this.getOrigin().getX()+x, this.getOrigin().getY()+y, this.getX2()-this.getX1(), this.getY2()-this.getY1(),this.arcw,this.arch);
	}

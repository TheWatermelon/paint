...
public class FigArrow extends FigureLine{
	
	public FigArrow (Point2D point1, Point2D point2, Color borderColor,Color fillColor, int stroke, int angle){  

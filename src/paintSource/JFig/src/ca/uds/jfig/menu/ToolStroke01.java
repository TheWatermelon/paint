...
public class ToolStroke01 extends ToolFig implements Command {

	private ToolStroke theToolStroke;
	ApplicationController acontroller;

	public ToolStroke01(ToolStroke ToolStroke, ApplicationController acontroller) {
		super(acontroller);

...
public class ToolStroke03 extends ToolFig implements Command {

	private ToolStroke theToolStroke;
	ApplicationController acontroller;

	public ToolStroke03(ToolStroke ToolStroke, ApplicationController acontroller) {
		super(acontroller);
